...
export default function Location({ handleChange, details }) {
	const [value, setValue] = useState(details && details.location);
	...
	return (
		<div className="relative px-4 py-8">
			...
			{!!suggestions.length && (
				<div
					className={`h-auto w-72 bg-primary text-primary rounded-md my-1 py-4 absolute top-[6em] left-4 border-2 border-gray-300 z-10`}
				>
